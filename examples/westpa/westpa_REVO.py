...
from wepy.runners.westpa import WestpaRunner, WestpaWalkerState, WestpaReporter, PairDistance, WestpaUnbindingBC
...
def main(n_walkers=36, n_workers=12, n_runs=1, n_cycles=20, n_steps=100, continue_sim=False):
    ...
    boundary_conditions = WestpaUnbindingBC(init_state, 3.0)
